  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      try {
        ...
        //     recruiterAPI.getInterviewFunnelAnalytics({ timeframe })
        // ]);
        ...
        setAnalytics({
          ...
          efficiencyInsights: [
            {
              title: "Technical Assessment Efficiency",
              description: "Strong performance in technical evaluation stage.",
              recommendation:
                "Continue with current technical assessment process.",
              impact: "Medium",
            },
            {
              title: "First Interview Bottleneck",
              description: "Lower pass rate at first interview stage needs attention.",
              recommendation:
                "Review interview criteria and provide interviewer training.",
              impact: "High",
            },
            {
              title: "High Offer Acceptance",
              description:
                "Excellent offer acceptance rate indicates competitive compensation.",
              recommendation: "Maintain current offer strategy and benefits package.",
              impact: "Low",
            },
          ],
        });
